...
@Client.on_message(filters.command(["playlist", f"playlist@{Config.BOT_USERNAME}"], PREFIX) & chat_filter)
...
@Client.on_message(filters.command(["skip", f"skip@{Config.BOT_USERNAME}"], PREFIX) & admin_filter & chat_filter)
...
@Client.on_message(filters.command(["pause", f"pause@{Config.BOT_USERNAME}"], PREFIX) & admin_filter & chat_filter)
...
@Client.on_message(filters.command(["resume", f"resume@{Config.BOT_USERNAME}"], PREFIX) & admin_filter & chat_filter)
...
@Client.on_message(filters.command(['volume', f"volume@{Config.BOT_USERNAME}"], PREFIX) & admin_filter & chat_filter)
...
@Client.on_message(filters.command(['vcmute', f"vcmute@{Config.BOT_USERNAME}"], PREFIX) & admin_filter & chat_filter)
...
@Client.on_message(filters.command(['vcunmute', f"vcunmute@{Config.BOT_USERNAME}"], PREFIX) & admin_filter & chat_filter)
...
@Client.on_message(filters.command(["replay", f"replay@{Config.BOT_USERNAME}"], PREFIX) & admin_filter & chat_filter)
...
@Client.on_message(filters.command(["player", f"player@{Config.BOT_USERNAME}"], PREFIX) & chat_filter)
...
@Client.on_message(filters.command(["seek", f"seek@{Config.BOT_USERNAME}"], PREFIX) & admin_filter & chat_filter)
...
@Client.on_message(filters.command(["settings", f"settings@{Config.BOT_USERNAME}"], PREFIX) & admin_filter & chat_filter)
