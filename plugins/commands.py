...
@Client.on_message(filters.command(["help", f"help@{Config.BOT_USERNAME}"], PREFIX))
...
@Client.on_message(filters.command(['repo', f"repo@{Config.BOT_USERNAME}"], PREFIX)
...
@Client.on_message(filters.command(['restart', 'update', f"restart@{Config.BOT_USERNAME}", f"update@{Config.BOT_USERNAME}"], PREFIX) & admin_filter & chat_filter)
...
@Client.on_message(filters.command(['logs', f"logs@{Config.BOT_USERNAME}"], PREFIX) & admin_filter & chat_filter)
...
@Client.on_message(filters.command(['env', f"env@{Config.BOT_USERNAME}", "config", f"config@{Config.BOT_USERNAME}"], PREFIX) & sudo_filter & chat_filter)
